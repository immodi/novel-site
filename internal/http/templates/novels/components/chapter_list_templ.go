...
func ChapterListComponent(novel *Novel) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/http/templates/novels/components/chapter_list.templ`, Line: 10, Col: 98}
		}
		...
		for _, chapter := range novel.Chapters {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/http/templates/novels/components/chapter_list.templ`, Line: 14, Col: 92}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/http/templates/novels/components/chapter_list.templ`, Line: 17, Col: 45}
			}
		...
		if isPreviousPage {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/http/templates/novels/components/chapter_list.templ`, Line: 28, Col: 104}
			}
		...
		for _, i := range pkg.MakePages(novel.TotalPages) {
			if i == novel.CurrentPage {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/http/templates/novels/components/chapter_list.templ`, Line: 36, Col: 86}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/http/templates/novels/components/chapter_list.templ`, Line: 39, Col: 87}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/http/templates/novels/components/chapter_list.templ`, Line: 42, Col: 29}
				}
		...
		if isNextPage {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/http/templates/novels/components/chapter_list.templ`, Line: 48, Col: 104}
			}
