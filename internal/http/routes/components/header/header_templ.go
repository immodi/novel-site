...
func Header(navLinks []string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 1, "<header class=\"w-full flex justify-between pt-4\"><a href=\"/\" class=\"text-3xl font-bold flex justify-center items-center ml-8\">Novels</a><nav class=\"flex items-center justify-center space-x-8 px-6 py-4 text-lg mr-4\">")
		if templ_7745c5c3_Err != nil {
		...
		for _, link := range navLinks {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/http/routes/components/header/header.templ`, Line: 10, Col: 35}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/http/routes/components/header/header.templ`, Line: 11, Col: 11}
			}
